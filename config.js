...
const GENEALOGY_CONFIG = {
  ...
  columns: {
    ...
    birthsPr: {
      columns: [
        { col: "год", width: "40px" },
        { label: "дата рождения", width: "50px", columns: ["день рождения", "месяц рождения"], join: ".", format: "date" },
        { label: "дата крещения", width: "50px", columns: ["день крещения", "месяц крещения"], join: ".", format: "date" },
        "имя ребенка",
        "имя отца",
        "отчество отца",
        "фамилия",
